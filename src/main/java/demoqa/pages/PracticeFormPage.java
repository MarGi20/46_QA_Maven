...
//div[@class='react-datepicker__week']//div[.='4']
    ...
    //label[.='Reading']
    public PracticeFormPage chooseHoobies(String[] hobbies) {
    ...
    public PracticeFormPage enterCurrentAdreess(String address) {
    ...
    public PracticeFormPage veritySuccessRegistration(String text) {
